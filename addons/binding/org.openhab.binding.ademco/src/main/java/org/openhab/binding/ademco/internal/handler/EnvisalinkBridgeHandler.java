...
public class EnvisalinkBridgeHandler extends BaseBridgeHandler {
        ...
        public void run() {
            ...
            while (connected) {
                try {
                    ...
                    logger.warn("Unknown exception occur but we will reconnect. {}", e);
                    closeConnection(true);
                }
            }
        }
        ...
        if (rawDataBytes.startsWith("%") && rawDataBytes.endsWith("$")) {
            ...
            switch (receivedCommand) {
                ...
                default:
                    ...
                    logger.warn("Operation " + rawDataBytes.substring(1, 3) + " not supported");
            }
            ...
            if (isCurrentState(EnvisalinkState.COMMAND_SEND)) {
                ...
                logger.debug("Command: " + command + ", status:" + status);
    ...
    // *
    // * @see
    // * org.eclipse.smarthome.core.thing.binding.BaseBridgeHandler#childHandlerInitialized(org.eclipse.smarthome.core.
    // * thing.binding.ThingHandler, org.eclipse.smarthome.core.thing.Thing)
    ...
    // * @see
    // *
    // org.eclipse.smarthome.core.thing.binding.BaseBridgeHandler#childHandlerDisposed(org.eclipse.smarthome.core.thing.
    // * binding.ThingHandler, org.eclipse.smarthome.core.thing.Thing)
    // */
    // @Override
